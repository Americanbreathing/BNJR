...
local Compkiller = {
	Version = '1.6',
	Logo = "rbxassetid://6319951718", -- Changed from 120245531583106
	Windows = {},
	Scale = {
...
function Compkiller.new(Config : Window)
	...
	function WindowArgs:Update(config: WindowUpdate)
		config = config or {};
		config.Logo = config.Logo or Config.Logo; -- Ensure lowercase config.Logo is set
		...
		Config.Logo = "rbxassetid://6319951718"; -- Force set to ensure it's always available
...
function Compkiller:Loader(IconId,Duration)
	...
	Icon.ZIndex = 100
	Icon.Image = IconId or "rbxassetid://6319951718" -- Changed from 120245531583106
	Icon.ImageTransparency = 1
